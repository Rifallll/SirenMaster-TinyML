...
def main():
    print("=================================================================")
    print("       PEMBERSIHAN TOTAL DATASET UTAMA - FINAL MISMATCHES        ")
    print("=================================================================")
    ...
    trash_dir = os.path.join("TRASH", "final_mismatches")
    ...
    print("\n=================================================================")
    print(f"SELESAI: Berhasil membersihkan {total_cleaned} file mismatch!")
