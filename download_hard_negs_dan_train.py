"""
download_hard_negs_dan_train.py
===========================
1. Download suara-suara rawan (Peluit, Alarm, Gerinda, Knalpot, Bayi, dll)
...
DOWNLOAD_DIR = r"C:\Users\ASUS\Videos\DATASET\TRASH\hardnegs_download"
os.makedirs(DOWNLOAD_DIR, exist_ok=True)
os.makedirs(NORMAL_DIR, exist_ok=True)

# ── Daftar pencarian YouTube untuk suara-suara "penipu" sirine ──
SEARCH_QUERIES = [
    "ytsearch1:suara peluit parkir panjang",
    "ytsearch1:suara alarm mobil sirine",
    "ytsearch1:suara mesin gerinda potong besi",
    "ytsearch1:suara knalpot racing geber",
    "ytsearch1:suara bayi menangis kencang",
    "ytsearch1:suara adzan masjid",
    "ytsearch1:suara klakson truk telolet panjang"
]

print("="*65)
print(" DOWNLOADER SUARA HARD NEGATIVES (ANTI FALSE POSITIVE)")
print("="*65)
...
for i, query in enumerate(SEARCH_QUERIES):
    ...
    out_tpl = os.path.join(DOWNLOAD_DIR, f"hardneg_{i+1:02d}.%(ext)s")
    ...
    found = glob.glob(os.path.join(DOWNLOAD_DIR, f"hardneg_{i+1:02d}.*"))
    if found:
...
for fpath in downloaded:
    ...
    try:
        ...
        for s in range(n_seg):
            ...
            out_name = os.path.join(NORMAL_DIR, f"noise_{base}_seg{s+1:04d}_{ts}.wav")
...
print(f"\n Total segmen suara pengecoh baru: {total_segments} file di folder NORMAL")

if total_segments > 0:
    print("\n" + "="*65)
    print(" Mulai Retrain Model AI (Memasukkan data pengecoh baru)...")
    print("="*65)
    ...
    print("\n ✅ SELESAI! Model tangguh jalanan baru siap.")
